...
$insert_pending_order = "insert into orders (customer_id,product_id,qty,color_primary, color_secondary,order_status) values ('$customer_id','$pro_id','$pro_qty','$color_primary', '$color_secondary','$status')";
