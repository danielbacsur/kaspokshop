...
$insert_pending_order = "insert into orders (customer_id,product_id,qty,color_primary, color_secondary, total, date, order_status) values ('$customer_id','$pro_id','$pro_qty','$pro_color_primary', '$pro_color_secondary', '$sub_total',  NOW(), '$status')";
